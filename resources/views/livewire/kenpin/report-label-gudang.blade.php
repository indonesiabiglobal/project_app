                                    ...
                                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                        <tr>
                                            <td style="border: 1px solid black;padding: 10px;">
                                                ...
                                                <font style="font-size: 33.2px;">6233</font>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="border: 1px solid black;padding: 3px;" height="105px">
                                                <span style="vertical-align: top;">Nama Produk </span><br>
                                                <span style="font-size: 28px;text-align:center;">Askul Tsumekae_70L White BM One Way</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="border: 1px solid black;padding: 3px;">
                                                <span style="vertical-align: top;">Jumlah Kotak (Box) </span>
                                                <font style="font-size: 42px;font-weight:bold;">0</font>
                                            </td>
                                        </tr>
                                        <tr>
