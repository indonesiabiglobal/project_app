            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h2 class="h6 modal-title">Add Master Loss Infure</h2>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-12 mb-1">
                                <div class="form-group">
                                    <label class="control-label col-12">Kode Loss </label>
                                    <div class="input-group col-12">
                                        <input class="form-control" type="text" placeholder="KODE LOSS" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12 mb-1">
                                <div class="form-group">
                                    <label class="control-label col-12">Nama Loss </label>
                                    <div class="input-group col-12">
                                        <input class="form-control" type="text" placeholder="nama loss" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12 mb-1">
                                <div class="form-group">
                                    <label class="control-label col-12">Klasifikasi Loss </label>
                                    <div class="input-group col-12">
                            ...
                            <div class="col-lg-12 mb-3">
                                <div class="form-group">
                                    <label class="control-label col-12">Kategori Loss </label>
                                    <div class="input-group col-12">
                                        <select class="form-control" placeholder="- all -">
                                            <option value="">- pilih -</option>
                                        </select>
                ...
                <table class="table table-centered table-nowrap mb-0 rounded">
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th class="border-0">Kode Loss</th>
                            <th class="border-0">Klasifikasi Loss</th>
                            <th class="border-0">Kategori Loss</th>
