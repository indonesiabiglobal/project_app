            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h2 class="h6 modal-title">Add Master Mesin</h2>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-12 mb-1">
                                <div class="form-group">
                                    <label class="control-label col-12">Nomor Mesin </label>
                                    <div class="input-group col-12">
                                        <input class="form-control" type="text" placeholder="KODE/NOMOR" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12 mb-1">
                                <div class="form-group">
                                    <label class="control-label col-12">Nama Mesin </label>
                                    <div class="input-group col-12">
                            ...
                            <div class="col-lg-12 mb-1">
                                <div class="form-group">
                                    <label class="control-label col-12">Departemen Mesin </label>
                                    <div class="input-group col-12">
                            ...
                            <div class="col-lg-12 mb-1">
                                <div class="form-group">
                                    <label class="control-label col-12">Kapasitas per jam (kg) </label>
                                    <div class="input-group col-12">
                                        <input class="form-control" type="text" placeholder="kapasitas per jam" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12 mb-1">
                                <div class="form-group">
                                    <label class="control-label col-12">Kapasitas per jam (meter/lembar) </label>
                                    <div class="input-group col-12">
                                        <input class="form-control" type="text" placeholder="kapasitas per jam" />
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-12 mb-3">
                                <div class="form-group">
                                    <label class="control-label col-12">Size </label>
                                    <div class="input-group col-12">
                ...
                <table class="table table-centered table-nowrap mb-0 rounded">
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th class="border-0">Kapasitas (kg)</th>
                            <th class="border-0">Kapasitas (qty)</th>
