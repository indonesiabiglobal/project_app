            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h2 class="h6 modal-title">Add Master Warehouse</h2>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-12 mb-1">
                                <div class="form-group">
                                    <label class="control-label col-12">Nama Warehouse </label>
                            ...
                            <div class="col-lg-12 mb-1">
                                <div class="form-group">
                                    <label class="control-label col-12">Deskripsi </label>
                                    <div class="input-group col-12">
                                        <textarea class="form-control" placeholder="deskripsi" rows="2" wire:model="remark"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12 mb-1">
                            ...
                            <div class="col-lg-12 mb-3">
                                <div class="form-group">
                                    <label class="control-label col-12">Propinsi </label>
                                    <div class="input-group col-12">
                                        <input class="form-control" type="text" placeholder="propinsi" />
                                    </div>
                                </div>
                            </div>
