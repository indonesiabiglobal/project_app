            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h2 class="h6 modal-title">Add Master Working Shift</h2>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-12 mb-1">
                                <div class="form-group">
                                    <label class="control-label col-12">Working Shift No </label>
                                    <div class="input-group col-12">
                                        <input class="form-control" type="text" placeholder="KODE SHIFT" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-12 mb-1">
                                <div class="form-group">
                                    <label class="control-label col-12">Jam Kerja Awal </label>
                                    <div class="input-group col-12">
                            ...
                            <div class="col-lg-12 mb-1">
                                <div class="form-group">
                                    <label class="control-label col-12">Jam Kerja Akhir </label>
                                    <div class="input-group col-12">
                                        <input class="form-control" id="time" type="time" placeholder="hh:mm">
                                    </div>
                                </div>
                ...
                <table class="table table-centered table-nowrap mb-0 rounded">
                    <thead class="thead-light">
                        <tr>
                            ...
                            <th class="border-0">Working Shift No</th>
                            <th class="border-0">Jam Kerja Awal</th>
                            <th class="border-0">Jam Kerja Akhir</th>
